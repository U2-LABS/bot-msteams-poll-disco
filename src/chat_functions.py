...
async def send_private_message(user_id: str, activity: Activity, turn_context: TurnContext):
...
async def send_chat_message(activity: Activity, turn_context: TurnContext):
